...
(52, 9, '尼沃一生推', 0, '2023-02-06 03:08:09', '2023-02-08 09:27:23'),
(53, 9, '希烟就是讚', 0, '2023-02-06 03:08:09', '2023-02-08 09:27:23'),
...
(9, '台灣VTuber CP', 1, 1, 0, '2023-02-06 03:08:09', '2023-02-08 09:27:39'),
...
CREATE TABLE `survey_upload` (
  `id` int(10) NOT NULL,
  `dname` text COLLATE utf8mb4_unicode_520_ci NOT NULL,
...
(2, 'ru', '00', 'ru@gmail.com', 1, 'ru', '2023-02-07 16:37:27', 0),
...
(6, 'ruzs2', '0913', 'ruzs2', 2, 'ruzs2', '2023-02-08 09:24:44', 0);
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `survey_upload`
--
ALTER TABLE `survey_upload`
