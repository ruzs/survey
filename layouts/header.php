  ...
  <nav class="d-flex justify-content-between py-3">
    <div class='img-block overflow-hidden'>
      <a class='mx-sm-2' href='index.php'>
        <img src='https://i.imgur.com/x5PnH9h.gif' class='my-sm-2' alt='投票主題' height="54px">
      </a>
    </div>
    <?php
    ...
    <div>
      ...
      <a class='m-sm-2' href='back.php?do=survey_add'><button type='button' class='btn btn-primary my-3 mx-auto'>新增投票</button></a>
    </div>
    <?php
        }
      }
    ...
    <div>
      ...
      if (isset($_SESSION['login'])) {
        if($user["level"]==2){
          echo "<a class='m-sm-2' href='back.php'><button type='button' class='btn btn-primary my-3 mx-auto'>回管理首頁</button></a>";
        }
        echo "<a class='m-sm-2' href='index.php'><button type='button' class='btn btn-primary my-3 mx-auto'>回網站首頁</button></a>";
        echo "<a class='m-sm-2' href='index.php?do=logout'><button type='button' class='btn btn-primary my-3 mx-auto'>使用者登出</button></a>";
      } else {
        echo "<a class='m-sm-2' href='?do=reg_user'><button type='button' class='btn btn-primary my-3 mx-auto'>使用者註冊</button></a>";
        echo "<a class='m-sm-2' href='?do=login'><button type='button' class='btn btn-primary my-3 mx-auto'>使用者登入</button></a>";
      }
      ?>
    </div>
  </nav>
